(function(root, factory) {
	...
	Paging.prototype = {
		...
		go: function(p) {
			...
			this.settings.callback && this.settings.callback(this.current, this.pagesize, this.pagecount,this.count);
		},
		...
		format: function() {
			var html = '<span style="float:left;font-size:15px;padding-top:3px">当前第'+this.current+'页 / 共'+this.pagecount+'页</span><ul>'
		...
		bindToolbar: function() {
			var _this = this;
			var html = $('<li class="ui-paging-toolbar"><select class="ui-select-pagesize"></select><input type="text" class="ui-paging-count" style="margin-top:-2px;"/><a href="javascript:void(0)" id="go" style="margin-top:1px;">跳转</a></li>');
